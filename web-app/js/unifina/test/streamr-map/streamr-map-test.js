...
var $ = require('jquery')(require('jsdom')
    .jsdom().defaultView)
...
describe('streamr-map', function() {
    ...
    beforeEach(function() {
        ...
        global.L = {
            ...
            Map: function() {
                ...
                _this.getCenter = _this.getZoom = function() {
                    return {}
                }
                return _this
            },
    ...
    describe('constructor', function() {
        it('must set the default values correctly', function() {
            ...
            assert(!map.animationFrameRequested)
        ...
        it('must not call createTraceLayer if !options.drawTrace', function(done) {
    ...
    describe('createTraceLayer', function() {
        ...
        it('must call latLngToContainerPoint and renderCircle for all the updates', function(done) {
            ...
            map.map.latLngToContainerPoint = latlng => latlng
            var layer = map.createTraceLayer()
            layer.render(true)
        })
    })
