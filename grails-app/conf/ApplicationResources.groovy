...
//		resource url:[dir:'js/unifina/webpack-bundles', file:'commons.bundle.css']
	...
	'stream-page-webpack-bundle' {
		dependsOn 'webpack-commons-bundle'
		resource url: [dir: 'js/unifina/webpack-bundles', file: 'streamPage.bundle.js', plugin: 'unifina-core']
		resource url: [dir: 'js/unifina/webpack-bundles', file: 'streamPage.bundle.css', plugin: 'unifina-core']
	}
	'signalpath-core' {
